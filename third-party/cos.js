...
class COS {
  ...
  /**
     ...
     * @param {Array<String>} allowPrefix 允许的存储桶内的前缀，如 images/*
     * @param {Number} durationSeconds 临时密钥有效时间，按秒计算
     * 
     * @returns {{credentials:{sessionToken:String,tmpSecretId:String,tmpSecretKey:String},expiredTime:Date,startTime:Date}} 临时密钥集合
     */
